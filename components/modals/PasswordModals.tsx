        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Senha de Demonstração" scale={scale}>
            <form noValidate onSubmit={handleSubmit} className="space-y-4">
                <input
                    ...
                    inputMode="numeric"
                />
                <button type="submit" className="w-full py-3 bg-primary text-white font-bold rounded-lg hover:bg-primary-dark transition-all transform hover:-translate-y-1 shadow-md hover:shadow-lg">
                    ENTRAR
                </button>
            </form>
        </Modal>
        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Senha do Sistema" scale={scale}>
            <form noValidate onSubmit={handleSubmit} className="space-y-4">
                <input
                    ...
                    autoFocus
                />
                <button type="submit" className="w-full py-3 bg-red-600/90 hover:bg-red-700 text-white font-bold rounded-lg transition-all transform hover:-translate-y-1 shadow-md hover:shadow-lg uppercase tracking-widest">
                    AUTORIZAR
                </button>
            </form>
