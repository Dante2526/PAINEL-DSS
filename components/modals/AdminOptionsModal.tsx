                    ...
                    {currentAdminNivel === '2' ? (
                        <>
                            ...
                            <button
                                ...
                                className={`col-span-2 p-3 rounded-xl flex flex-col items-center justify-center gap-1.5 transition-all duration-300 shadow-md h-[86px] md:h-[82px] hover:-translate-y-1 hover:scale-[1.03] hover:shadow-lg active:scale-[0.98] transform ${isSorteioActive ? 'bg-red-500 hover:bg-red-600 text-white' : 'bg-emerald-500 hover:bg-emerald-600 text-white'}`}
                            >
                            ...
                            <button
                                ...
                                className={`col-span-2 p-3 rounded-xl flex flex-col items-center justify-center gap-1.5 transition-all duration-300 shadow-md h-[86px] md:h-[82px] hover:-translate-y-1 hover:scale-[1.03] hover:shadow-lg active:scale-[0.98] transform ${isPularTelasActive ? 'bg-red-500 hover:bg-red-600 text-white' : 'bg-emerald-500 hover:bg-emerald-600 text-white'}`}
                            >
                            ...
                            <div className="col-span-2 grid grid-cols-2 gap-2 md:gap-3">
                                ...
                                >
                                    ...
                                    <span className="font-bold text-[10px] md:text-xs uppercase tracking-wider text-center leading-tight">
                                        {isAdminOnlyTheme ? "TEMA: ACESSO LIVRE" : "TEMA: APENAS ADM"}
                                    </span>
                                </button>
                            </div>
                        ...
                        <>
                            ...
                            <div className="col-span-2 grid grid-cols-2 gap-2 md:gap-3 mt-1 md:mt-1">
                                ...
                                <button
                                    id="admin-password-btn"
                                    onClick={onChangeAdminPassword}
                                    className={`p-3 bg-gray-700 hover:bg-gray-800 dark:bg-gray-800 dark:hover:bg-gray-900 text-white rounded-xl flex flex-col items-center justify-center gap-1.5 transition-all duration-300 shadow-md h-[86px] md:h-[82px] hover:-translate-y-1 hover:scale-[1.03] hover:shadow-lg active:scale-[0.98] transform`}
                                >
                                    <div className="scale-[0.85] md:scale-90 origin-bottom"><svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" /></svg></div>
                                    <span className="font-bold text-[10px] md:text-xs uppercase tracking-wider text-center leading-tight">MINHA SENHA</span>
                                </button>
