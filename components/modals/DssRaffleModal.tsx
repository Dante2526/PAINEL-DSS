            ...
            <div className="flex flex-col items-center justify-center p-2 py-4 animate-in fade-in zoom-in-95 duration-300">
                <div className="w-full bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/10 border-2 border-amber-400/30 dark:border-amber-500/30 rounded-2xl p-5 shadow-lg text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <div className="mx-auto w-16 h-16 bg-amber-100 dark:bg-amber-900/50 rounded-2xl flex items-center justify-center mb-4 shadow-inner border border-amber-200 dark:border-amber-700/50 -rotate-3">
                            <svg className="w-8 h-8 text-amber-600 dark:text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" />
                            </svg>
                        </div>
                        
                        <h3 className="text-sm font-black text-amber-800 dark:text-amber-300 uppercase tracking-widest mb-3">
                            PARABÉNS, {employeeName.split(' ')[0]}!
                        </h3>
                        
                        <div className="space-y-3 mb-5 text-[13px] md:text-sm font-medium text-amber-950/80 dark:text-amber-100/80 leading-relaxed text-left">
                            <p>
                            ...
                            <div className="bg-white/60 dark:bg-black/20 p-3 rounded-lg border border-amber-100 dark:border-amber-800/50">
                                <p className="text-[12px] md:text-[13px] text-amber-800/90 dark:text-amber-200/80 leading-snug">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-1">
                                <label className="block text-xs font-bold text-amber-800 dark:text-amber-300 text-left ml-1">
                                    TEMA DA DSS:
                                </label>
                                <input
                                    ref={inputRef}
                                    ...
                                    className="w-full px-4 py-3 bg-white dark:bg-gray-800 border-2 border-amber-200 dark:border-amber-700/50 rounded-xl focus:ring-2 focus:ring-amber-400 focus:border-amber-400 dark:text-white transition-all shadow-inner uppercase"
                                    required
                                />
                            </div>
                            ...
                            <div className="space-y-1">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-white dark:bg-gray-800 border-2 border-amber-200 dark:border-amber-700/50 rounded-xl focus:ring-2 focus:ring-amber-400 focus:border-amber-400 dark:text-white transition-all shadow-inner uppercase font-mono"
                                    required
                                />
                            </div>
                            ...
                            <div className="flex gap-2 pt-2">
                                <button
                                    type="button"
                                    onClick={onClose}
                                    className="flex-1 py-3.5 bg-white dark:bg-gray-800 text-amber-700 dark:text-amber-300 border-2 border-amber-200 dark:border-amber-700/50 rounded-xl font-bold uppercase tracking-widest hover:bg-amber-50 dark:hover:bg-amber-900/30 transition-all active:scale-95"
                                >
                                    AGORA NÃO
                                </button>
                                <button
