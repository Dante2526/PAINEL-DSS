                ...
                <main className="flex flex-col items-center text-center m-auto w-full max-w-2xl px-2">
                    ...
                    <div className="flex justify-center w-full md:w-3/4 lg:w-2/3 px-4 md:px-0 mx-auto mb-8">
                        <button
                            ...
                            className="w-full max-w-sm md:max-w-none md:w-[calc(50%-0.5rem)] px-6 md:px-12 py-6 md:py-8 font-extrabold text-lg md:text-2xl text-white bg-gradient-to-br from-pink-500 to-rose-700 rounded-2xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1.5 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-rose-300 dark:focus:ring-rose-800"
                        >
                            TURMA C CG
