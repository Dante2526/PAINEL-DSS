...
const shiftLabel = (TARGET_TEAM === 'C' || TARGET_TEAM === 'D' || TARGET_TEAM === 'C_CG' || TARGET_TEAM === 'D_CG' || TARGET_TEAM === 'C_CCP_CG' || TARGET_TEAM === 'D_CCP_CG') ? '18H' : '6H';
const mainShiftLabel = (TARGET_TEAM === 'C' || TARGET_TEAM === 'D' || TARGET_TEAM === 'C_CG' || TARGET_TEAM === 'D_CG' || TARGET_TEAM === 'C_CCP_CG' || TARGET_TEAM === 'D_CCP_CG') ? '19H' : '7H';
