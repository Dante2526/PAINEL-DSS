...
export default async function handler(req, res) {
  ...
  try {
    ...
    const shiftLabel = (validatedTeam === 'C' || validatedTeam === 'D' || validatedTeam === 'C_CG' || validatedTeam === 'D_CG' || validatedTeam === 'C_CCP_CG' || validatedTeam === 'D_CCP_CG') ? '18H' : '6H';
    const mainShiftLabel = (validatedTeam === 'C' || validatedTeam === 'D' || validatedTeam === 'C_CG' || validatedTeam === 'D_CG' || validatedTeam === 'C_CCP_CG' || validatedTeam === 'D_CCP_CG') ? '19H' : '7H';
